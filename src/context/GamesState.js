...
const GamesState = (props) => {
    ...
    const handleSearch = async (query) => {
        try {
            ...
            setData({ searchResults: response.results });
        } catch (error) {
            console.log(error);
        }
    }
    ...
    return (
        <GamesContext.Provider
            value={{
                ...
                gamesPC: data.gamesPC,
                gamesPlaystation4: data.gamesPlaystation4,
                gamesXboxOne: data.gamesXboxOne,
                gamesNintendoSwitch: data.gamesNintendoSwitch,
                gamesIos: data.gamesIos,
                gamesAndroid: data.gamesAndroid,
