    ...
    return (
        <Menu {...props}>
            ...
            <ul>
                ...
                <li>
                    <span><GiGamepad /></span>
                    <NavLink exact id="home" className="menu-item" to="/last-30-days" activeClassName="selected">Platforms</NavLink>
                </li>
                <li>
                    <span><FaDownload /></span>
                    <NavLink exact id="about" className="menu-item" to="/this-week" activeClassName="selected">Stores</NavLink>
                </li>
                <li>
                    <span><FaGhost /></span>
                    <NavLink exact id="contact" className="menu-item" to="/next-week" activeClassName="selected">Genres</NavLink>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    ...
                    <NavLink exact id="home" className="menu-item" to="/pc" activeClassName="selected">PC</NavLink>
                </li>
                <li>
                    <span><FaPlaystation /></span>
                    <NavLink exact id="about" className="menu-item" to="/playstation4" activeClassName="selected">Playstation 4</NavLink>
                </li>
                <li>
                    <span><FaXbox /></span>
                    <NavLink exact id="contact" className="menu-item" to="/xbox-one" activeClassName="selected">Xbox One</NavLink>
                </li>
                <li>
                    <span><SiNintendoswitch /></span>
                    <NavLink exact id="contact" className="menu-item" to="/nintendo-switch" activeClassName="selected">Nintendo Switch</NavLink>
                </li>
                <li>
                    <span><MdPhoneAndroid /></span>
                    <NavLink exact id="contact" className="menu-item" to="/ios" activeClassName="selected">iOS</NavLink>
                </li>
                <li>
                    <span><AiFillAndroid /></span>
                    <NavLink exact id="contact" className="menu-item" to="/android" activeClassName="selected">Android</NavLink>
                </li>
            </ul>
