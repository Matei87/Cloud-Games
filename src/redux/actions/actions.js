...
export const BestOfTheYearAction = () => {
    return async (dispatch) => {
        try {
            const API_KEY = '63150f4e38d549339ba029a37509023c';
            const BEST_OF_THE_YEAR = `https://api.rawg.io/api/games?key=${API_KEY}&dates=2021-01-01,2021-12-31&ordering=-added&page=1`;
            let promise = await fetch(BEST_OF_THE_YEAR)
            let result = await promise.json();
            dispatch({ type: 'FETCH_BEST_OF_THE_YEAR', payload: result.results, isBestOfTheYearLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const popularIn2020Action = (page = 1) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_POPULAR_IN_2020', payload: result.results, isPopularIn2020Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const popularIn2019Action = (page = 1) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_POPULAR_IN_2019', payload: result.results, isPopularIn2019Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const allTimePopularAction = (page = 1) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_ALL_TIME_POPULAR', payload: result.results, isAllTimePopularLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const last30DaysAction = (page = 1) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_LAST_30_DAYS', payload: result.results, isLast30DaysLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const thisWeekAction = (page = 1) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_THIS_WEEK', payload: result.results, isThisWeekLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const nextWeekAction = (page = 1) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_NEXT_WEEK', payload: result.results, isNextWeekLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const gamesPCAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PC', payload: result.results, isGamesPCLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const playStationAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PLAYSTATION', payload: result.results, isPlayStationLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const playStation2Action = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PLAYSTATION_2', payload: result.results, isPlayStation2Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const playStation3Action = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PLAYSTATION_3', payload: result.results, isPlayStation3Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const playStation4Action = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PLAYSTATION_4', payload: result.results, isPlayStation4Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const playStation5Action = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PLAYSTATION_5', payload: result.results, isPlayStation5Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const xboxOneAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_XBOX_ONE', payload: result.results, isXboxOneLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const XboxSeriesSXAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_XBOX_SERIES_SX', payload: result.results, isXboxSeriesSXLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const xbox360Action = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_XBOX_360', payload: result.results, isXbox360Loaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const xboxOldAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_XBOX_OLD', payload: result.results, isXboxOldLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const nintendoSwitchAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_NINTENDO_SWITCH', payload: result.results, isNintendoSwitchLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const nintendoDSAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_NINTENDO_DS', payload: result.results, isNintendoDSLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const nintendoDSIAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_NINTENDO_DSI', payload: result.results, isNintendoDSILoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const nintendo3DSAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_NINTENDO_3DS', payload: result.results, isNintendo3DSLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const iosAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_IOS', payload: result.results, isIosLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const androidAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_ANDROID', payload: result.results, isAndroidLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const linuxAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_LINUX', payload: result.results, isLinuxLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const macOSAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_MACOS', payload: result.results, ismacOSLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const wiiuAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_WIIU', payload: result.results, isWiiULoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const wiiAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_WII', payload: result.results, isWiiLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const pspAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PSP', payload: result.results, isPSPLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const pSVitaAction = () => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_GAMES_PSVITA', payload: result.results, isPSVitaLoaded: false })
        } catch (error) {
            console.log(error)
        }
    }
...
export const searchAction = (query) => {
    return async (dispatch) => {
        try {
            ...
            let result = await promise.json();
            dispatch({ type: 'FETCH_SEARCH_RESULTS', payload: result.results, isSearchLoaded: true })
        } catch (error) {
            console.log(error)
        }
    }
