...
import { XboxSeriesSXAction } from '../../../redux/actions/actions';
import { connect } from 'react-redux';


const PlatformXboxSeriesSX = ({ gamesXboxSeriesSX, getData, isXboxSeriesSXLoaded }) => {
    console.log(gamesXboxSeriesSX, isXboxSeriesSXLoaded);
    ...
    return (
        <div id="content" className="main-page">
            ...
            {isXboxSeriesSXLoaded === true ? <div className="container">

                <div className="gamesDetails">
                    <p>Games for Xbox Series S/X</p>
                </div>

                <div className="main-wrapper">

                    {gamesXboxSeriesSX.map(data => {
...
const mapDispatchToProps = dispatch => ({
    getData: games => dispatch(XboxSeriesSXAction(games))
})

const mapStateToProps = state => ({
    gamesXboxSeriesSX: state.gamesXboxSeriesSX.gamesXboxSeriesSX,
    isXboxSeriesSXLoaded: state.gamesXboxSeriesSX.isXboxSeriesSXLoaded
})

export default connect(mapStateToProps, mapDispatchToProps)(PlatformXboxSeriesSX);