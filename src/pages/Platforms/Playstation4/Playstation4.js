...
import { playStation4Action } from '../../../redux/actions/actions';
import { connect } from 'react-redux';


const PlatformPlaystation4 = ({ gamesPlaystation4, getData, isPlayStation4Loaded }) => {
    console.log(gamesPlaystation4, isPlayStation4Loaded);
    ...
    return (
        <div id="content" className="main-page">
            ...
            {isPlayStation4Loaded === true ? <div className="container">
...
const mapDispatchToProps = dispatch => ({
    getData: games => dispatch(playStation4Action(games))
})

const mapStateToProps = state => ({
    gamesPlaystation4: state.gamesPlaystation4.gamesPlaystation4,
    isPlayStation4Loaded: state.gamesPlaystation4.isPlayStation4Loaded
})

export default connect(mapStateToProps, mapDispatchToProps)(PlatformPlaystation4);