...
import { pSVitaAction } from '../../../redux/actions/actions';
import { connect } from 'react-redux';


const PlatformPSVita = ({ gamesPSVita, getData, isPSVitaLoaded }) => {
    console.log(gamesPSVita, isPSVitaLoaded);
    ...
    return (
        <div id="content" className="main-page">
            ...
            {isPSVitaLoaded === true ? <div className="container">

                <div className="gamesDetails">
                    <p>Games for PSVita</p>
                    <h1 className="gamesDetails">
                        PS Vita is a handheld video game console released in 2012 by Sony. The platform comes with either 3G+Wi-Fi network or in Wi-Fi only bundle.
                        There are two hardware variations of the console: original and second (referred to as "slim").
                        The slim version differs with the display port removed, 3G cut, and internal storage added.
                        There is also PlayStation TV released on Vita hardware. However, not all the games are compatible with it.
                        PS Vita is usually considered the most powerful handheld console in the video game history.
                        Nevertheless, the first-party developers have quickly lost interest in making games for it leaving a platform for third-party titles and port games from previous generations.
                        A PlayStation Plus support will also be removed from the console by 8th March 2019 likely leading to a halt of overall platform support.
                    </h1>
                </div>

                <div className="main-wrapper">

                    {gamesPSVita.map(data => {
...
const mapDispatchToProps = dispatch => ({
    getData: games => dispatch(pSVitaAction(games))
})

const mapStateToProps = state => ({
    gamesPSVita: state.gamesPSVita.gamesPSVita,
    isPSVitaLoaded: state.gamesPSVita.isPSVitaLoaded
})

export default connect(mapStateToProps, mapDispatchToProps)(PlatformPSVita);